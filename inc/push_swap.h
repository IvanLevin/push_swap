...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/01 17:11:08 by breolson          #+#    #+#             */
/*   Updated: 2019/04/01 17:11:13 by breolson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef PUSH_SWAP_H
# define PUSH_SWAP_H
# define CMD swap->temp_cmd
# define TMP swap->temp
# define UM swap->uns_mas
# define CMNDS swap->cmnd
